...
import DeleteTrueOrFalseQuestionCSVFile from "../../../../../PageObject/delete_true_or_false_question_csv_file";

const landingpage = new LandingPage();
const dashboard = new Dashboard();
const testmanagement = new TestManagementTab();
const multiplechoicepage = new MultipleChoicePage();
const deletetrueorfalsequestioncsvfileformat = new DeleteTrueOrFalseQuestionCSVFile()
